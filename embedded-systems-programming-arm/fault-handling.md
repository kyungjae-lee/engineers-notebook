<a href="../">Notebook</a> > <a href="./">Embedded Systems Programming (ARM)</a> > Fault Handling
...
* The fault is an exception generated by the processor to indicate an error. Faults are nothing but **system exceptions**.

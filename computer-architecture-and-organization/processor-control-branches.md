<a href="../../">Home</a> > <a href="../notebook">Notebook</a> > <a href="./">Computer Architecture & Organization</a> > Processor Control - Branches
...
2. Take a guess
   ...
   If guessed right there will be no performance degrade (Good!). But, if guessed worng **bubble** (or **hole**) will be introduced into the pipeline. 
...
5. If a branch is not taken, there is no penalty and only 1 cycle is required.
...
### 6.2. Dynamic Branch Prediction (Speculative Execution)
...
#### 6.2.1. 2-Bit Saturating Counter Branch Predictor State Diagram
...
#### 6.2.2. Alternative 2-Bit Branch Predictor State Diagram
...
#### 6.2.3. Branch Target Buffer (BTB)
...
##### 6.2.3.1. The Simple Branch Target Buffer
...
##### 6.2.3.2. Modified  Branch Target Buffer with Cached Op-code at Mispredicted Address
...
### 6.2.4. Two-Level Branch Prediction

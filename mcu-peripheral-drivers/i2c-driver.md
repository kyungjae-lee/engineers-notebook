...
/**
 * RCC_GetPCLK1Value()
 * Desc.	: Computes and returns I2C1 peripheral clock frequency
 * Param.	: None
 * Return	: I2C1 peripheral clock frequency
 * Note		: Similarly 'RCC_GetPCLKxValue()' (x = 1,2,...) can be defined if
 * 			  there are other I2Cx peripherals connected to other buses.
 */

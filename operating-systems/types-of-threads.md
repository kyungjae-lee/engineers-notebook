<a href="../">Notebook</a> > <a href="./">Operating Systems</a> > Types of Threads
...
* It a pure KLT system, all of the work of thread management is done by the kernel so, **kernel is aware of all threads**. There is no thread management code in the application level, simply an application programming interface (API) to the kernel thread facility. (e.g., Windows)
...
* Relationship between Threads and Processes
  ...
  | M:1                 | A process defines an address space an dynamic resource ownership. Multiple threads may be created an executed within that process. | Windows NT, Solaris, Linux, OS/2, OS/390, MACH |
